...
::: {.essay-card}
### [The Denominator Problem in Statistical Evidence](essays/denominator_problem_statistical_evidence.qmd)
...
::: {.essay-card}
### [The More Places You Look, The More You Find](essays/the-more-places-you-look-the-more-you-find.qmd)
Multiple testing can distort p-values in product-liability, employment, procurement, securities, and healthcare-fraud cases when experts search across many outcomes, subgroups, definitions, time periods, or models. Lawyers evaluating statistical evidence should ask how much searching preceded the reported result before treating it as meaningful proof.
:::
