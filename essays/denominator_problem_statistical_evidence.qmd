...
But the _count_ is only the legally sexy half of a _rate_. The missing half is the denominator: the population of opportunities, transactions, claims, products, patients, employees, or applications from which the count arose. Without that denominator, it may be impossible to determine whether the count is alarming or thoroughly ordinary.
