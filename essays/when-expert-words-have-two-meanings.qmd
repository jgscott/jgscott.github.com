...
Important, but not the same as saying _why_ the events are related.
...
Now suppose a statistical expert analyzes the hiring data and concludes that the outcomes were not independent. The expert means something quite specific: _rejection rates move together across offices_. Offices with lower hiring rates for one group tend to have lower hiring rates for that group elsewhere. Once we know what happened in one office, we can make a better probabilistic prediction about what happened in another.
