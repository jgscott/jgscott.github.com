...
The second form of validation is _substantive_. Here we ask a different question: once the model has identified a provider as statistically unusual, does that alarm reliably correspond to something real in the world? In a healthcare fraud matter, the relevant real-world condition may be fraud, abuse, false claims, lack of medical necessity, or some other problem tied to the legal claims in the case.
